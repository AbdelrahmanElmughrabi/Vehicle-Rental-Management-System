...
public class StationWagon_45 extends Car_45 implements remoteOrDropableOff_45,loadable_45,Serializable{
    
   private int vehicleLoadingCapacity;
    public StationWagon_45(int plateNumber, int numberOfTires, double dailyFee, String color, int seatingCapacity, int numberOfDoors, int vehicleLoadingCapacity) {
